...
public abstract class GlobalConstants {
    ...
    public static final String POST_CREATE_CLIENT = "creacliente";

    public static final String GET_CLIENT_KPI = "kpideclientes";

    public static final String GET_LIST_CLIENTS = "listclientes";
